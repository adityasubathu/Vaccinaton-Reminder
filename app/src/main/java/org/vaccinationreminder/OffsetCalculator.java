...
public class OffsetCalculator {
    ...
    public String[] vaccineList = {"BCG", "OPV 0", "Hep–B 1", "DTwP 1", "IPV 1", "Hep–B 2", "Hib 1", "Rotavirus 1", "PCV 1", "DTwP 2",
            "IPV 2", "Hib 2", "Rotavirus 2", "PCV 2", "DTwP 3", "IPV 3", "Hib 3", "Rotavirus 3", "PCV 3", "OPV 1", "Hep–B 3", "OPV 2",
            "MMR 1", "TCV", "Hep–A 1", "MMR 2", "Varicella 1", "PCV booster", "DTwP B1/DTaP B1", "IPV B1", "Hib B1", "Hep–A 2",
            "Booster of Typhoid", "Conjugate Vaccine", "DTwP B2/DTaP B2", "OPV 3", "Varicella 2", "MMR 3", "Tdap/Td", "HPV"};

    //Array for number of weeks each of the above vaccine is due
    public int[] weekList = {1, 1, 1, 6, 6, 6, 6, 6, 6, 10, 10, 10, 10, 10, 14, 14, 14, 14, 14, 26, 26, 36, 36, 52, 52, 60, 60, 60, 72, 72, 72,
            72, 104, 104, 208, 208, 208, 208, 520, 520};
